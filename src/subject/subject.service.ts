...
export class SubjectService {
    ...
    async updateSubject(subjectId: string, updateSubjectDto: UpdateSubjectDto):Promise <ISubject> {
        const existingSubject = await this.subjectModel.findByIdAndUpdate(subjectId, updateSubjectDto,{new: true});
    if (!existingSubject){
